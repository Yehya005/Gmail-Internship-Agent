...
def _system_prompt() -> str:
    return (
        ...
        "Rules:\n"
        "1. **Scam Risk** — apply when the email asks for upfront fees / "
        "registration deposits / payment to receive an offer, skips "
        "standard hiring steps (no interview, instant hire, fast-track), "
        "uses urgency cues to push action (\"limited seats\", \"register "
        "today\"), or shows other classic scam patterns. Scam Risk is "
        "EXCLUSIVE — when you apply it, do NOT add topic labels. You are "
        "the sole scam judge for this email; if you don't apply it, no "
        "one else will.\n"
        "2. If the email is not actually an internship offer relevant to "
        "this candidate's CV (marketing pitch, unrelated domain, generic "
        "newsletter), return [].\n"
